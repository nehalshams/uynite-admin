...
export function Tables() {
  ...
  const handleProfileClick = (name) => {
    // console.log(name, "PPPPPPPPPPPPP NNNNNNNAAAAAAAAAAMEEEEEEEEE");
        ...
        >
          <div>
            ...
            <Typography className="text-sm">
              Pending 66 | Verified 66 | Rejected 88
            </Typography>
          </div>
        ...
        >
          ...
          >
            <div>
              ...
              />
              <Typography color="blue-gray" className="text-center">ID Name</Typography>
            </div>
            <div>
              <img
                className="min-h-[180px]"
